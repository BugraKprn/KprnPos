...
namespace DataAccess.Layer.Migrations
{
    ...
    [Migration("20240519011427_mig_add_Payment_PaymentRequest_PaymentResponse")]
    partial class mig_add_Payment_PaymentRequest_PaymentResponse
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Layer.Concrete.PaymentRequest", b =>
                {
                    b.Property<int>("PaymentRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Layer.Concrete.PaymentResponse", b =>
                {
                    b.Property<int>("PaymentResponseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PaymentResponseId"), 1L, 1);
            ...
            modelBuilder.Entity("Entity.Layer.Concrete.Payment", b =>
                {
                    b.HasOne("Entity.Layer.Concrete.PaymentRequest", null)
                        .WithMany("Payments")
